...
function CarCard(props: any) {
  ...
  return car&&(
    ...
    >
      ...
      <h2 className="text-[16px] font-medium mb-2">{car.range}
      <span className="text-[12px] font-light">KM</span></h2>
      ...
      <div className=" text-center text-gray-600">
        <BsLightningChargeFill className="w-full text-[22px] mb-2" />
        <h2 className="line-clamp-5 text-[14px] font-light">
          {car.dccharging}KW
        </h2>
      </div>
      <div className=" text-center text-gray-600">
        <FaRupeeSign className="w-full text-[22px] mb-2" />
        <h2 className="line-clamp-5 text-[14px] font-light">
          {car.price}
